...
for (const file of ['api/send-email.js', 'api/outbox.js', 'api/intake.js', 'api/public-form.js', 'api/runtime-config.js', 'server/public-intake.js', 'server/outbox.js', 'netlify/functions/intake.js', 'netlify/functions/send-email.js',
  ...
  'tools/identity-foundation-test.js', 'tools/tenant-foundation-test.js', 'tools/organization-settings-test.js', 'tools/employee-privacy-test.js', 'tools/public-intake-test.js', 'tools/delivery-outbox-test.js', 'tools/recruitment-v2-test.js', 'tools/sales-client-workspace-v2-test.js', 'tools/finance-v2-test.js', 'tools/preflight-staging-migration.js',
  'tools/reconcile-staging-identity.js', 'tools/test-staging-identity.js',
  'tools/test-staging-app-login.js', 'tools/test-staging-tenant-rls.js', 'tools/test-staging-organization-settings.js', 'tools/test-staging-employee-privacy.js', 'tools/test-staging-public-forms.js', 'tools/test-staging-public-intake.js', 'tools/test-staging-delivery-outbox.js', 'tools/test-staging-recruitment-v2.js', 'tools/test-staging-sales-client-workspace-v2.js', 'tools/test-staging-finance-v2.js',
